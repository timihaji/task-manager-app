...
const TASK_TO_ROW_KEYS = {
  ...
  snoozeMode: 'snooze_mode',
  snoozeOffsetDays: 'snooze_offset_days',
  ...
  personalReminderDate: 'personal_reminder_date',
...
const TASK_DB_COLUMNS = new Set([
  ...
  'date', 'due_date', 'done', 'completed_at', 'snoozed_until', 'snoozed_at', 'snooze_mode', 'snooze_offset_days', 'someday', 'recurrence',
